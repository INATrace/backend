...
public class ProcessingEvidenceFieldController {
	...
	public ApiPaginatedResponse<ApiProcessingEvidenceField> getProcessingEvidenceFieldList(@Valid ApiPaginatedRequest request) {

		return new ApiPaginatedResponse<>(processingEvidenceFieldService.getProcessingEvidenceFieldList(request));
	}
	...
	public ApiResponse<ApiProcessingEvidenceField> getProcessingEvidenceField(@Valid @ApiParam(value = "ProcessingEvidenceField ID", required = true) @PathVariable("id") Long id) throws ApiException {

		return new ApiResponse<>(processingEvidenceFieldService.getProcessingEvidenceField(id));
	}
